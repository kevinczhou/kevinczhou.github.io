...
[[link](https://opg.optica.org/oe/fulltext.cfm?uri=oe-30-2-1745&id=467320)]  

1. **High-speed multi-view imaging approaching 4pi steradians using conic section mirrors: theoretical and practical considerations** (*Editor's Pick*)  
...
1. **Mesoscopic photogrammetry with an unstabilized phone camera**  
...
1. **Diffraction tomography with a deep image prior**  
...
1. **Fourier ptychography: current applications and future promises**  
...
1. **Learned sensing: jointly optimized microscope hardware for accurate image classification** (*Editor's Pick*)  
...
1. **Unraveling the molecular nature of melanin changes in metastatic cancer**  
...
1. **Stimulated Raman scattering spectroscopic optical coherence tomography**  
...
1. **Improved velocimetry in optical coherence tomography using Bayesian analysis**  
...
1. **Quantifying uncertainty in the phylogenetics of Australian numeral systems**  
...
1. **The use of optical clearing and multiphoton microscopy for investigation of three-dimensional tissue-engineered constructs**  
...
1. **Developmental modification of synaptic NMDAR composition and maturation of glutamatergic synapses: matching postsynaptic slots with receptor pegs**  
...
1. **Incoherent 3D k-space synthesis with volumetric optical coherence refraction tomography** (*Best student paper award*)  
...
1. **Computational 3D imaging, from optical coherence tomography and microscopes to your smartphone** (*Invited seminar*)  
<ins>Kevin C. Zhou</ins>  
Fitzpatrick Institute for Photonics (FIP), 2021.

1. **Snapshot 3D imaging with a gigapixel-scale multi-aperture microscope** (*Talk*)  
...
1. **Resolution enhancement and speckle reduction in coherence imaging: a k-space model of optical coherence refraction tomography (OCRT)**  (*Invited talk*) (*OSA Biophotonics Student Award*)  
<ins>Kevin C. Zhou</ins>, Ruobing Qian, Sina Farsiu, Joseph A. Izatt  
OSA Biophotonics Congress 2020.  
[[link](https://www.osapublishing.org/abstract.cfm?uri=OCT-2020-OTu1E.2)]

1. **Optical coherence refraction tomography** (*Invited seminar*)  
<ins>Kevin C. Zhou</ins>  
Berkeley Center for Computational Imaging (BCCI), 2020.

1. **High-resolution 3D imaging using Fourier ptychographic tomography with a deep image prior** (*Talk*)  
<ins>Kevin C. Zhou</ins>, Roarke Horstmeyer  
...
1. **Improving diffraction tomography with intensity-only images** (*Invited talk*)  
<ins>Kevin C. Zhou</ins>  
...
1. **Spectroscopic optical coherence refraction tomography for isotropically resolved imaging with simultaneously high spatial and spectral resolution** (*Talk*)  
<ins>Kevin C. Zhou</ins>, Ruobing Qian, Sina Farsiu, Joseph A. Izatt  
SPIE Photonics West 2019, San Francisco, CA.

1. **Optical coherence refraction tomography for isotropically resolved cross-sectional imaging** (*Talk*)  
<ins>Kevin C. Zhou</ins>, Ruobing Qian, Sina Farsiu, Joseph A. Izatt  
SPIE Photonics West 2018, San Francisco, CA.

1. **Stimulated Raman scattering (SRS) spectroscopic OCT**  
Francisco E. Robles, <ins>Kevin C. Zhou</ins>, Martin C. Fischer, Warren S. Warren  
SPIE Photonics West 2017, San Francisco, CA.

1. **Visualizing convolutional neural networks for extracting structural and chemical information from pump-probe microscopy of melanoma** (*Poster*)  
...
1. **Towards all-optical quantification of ciliary physiology**  
...
1. **OCT-based three-dimensional, three vector component imaging of cilia-driven fluid flow for developmental biology**  
...
1. **Particle streak velocimetry-OCT (PSV-OCT): a novel method for multi-vector component velocimetry of microscale flow physiology** (*Talk*)  
<ins>Kevin C. Zhou</ins>, Brendan K. Huang, Ute A. Gamm, Vineet Bhandari, Mustafa K. Khokha, Michael A. Choma  
SPIE Photonics West 2016, San Francisco, CA.  
...
1. **Multiphoton microscopy of cleared human tissue for 3D histology**  
